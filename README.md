...
| :--- | :--- | :--- |
| **Misspelt (Game)** | Desarrollo del videojuego base utilizando Godot y diseño de lógicas personalizadas. | [Repositorio](https://github.com/Pakelin3/Misspelt-game) |
| **Misspelt (App/Web)** | Arquitectura y desarrollo del ecosistema complementario de la aplicación. | [Repositorio](https://github.com/Pakelin3/Misspelt) |
